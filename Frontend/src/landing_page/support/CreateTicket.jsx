    ...
    return (
        <div className='container'>
            <div className="row mt-5">
                <h1 className='fs-2' style={{color: "#000"}}>
                    To create a ticket, select a relevant topic
                </h1>
            </div>
            <div className="row">
                <div className="col-4 p-5 mt-2 mb-2">
                <h4 className='fs-4' style={{color: "#000"}}>
                    <i class="fa-solid fa-circle-plus"></i> Account Opening <br/>
                </h4>
            ...
            <div className="col-4 p-5 mt-2 mb-2">
                <h4 className='fs-4' style={{color: "#000"}}>
                    <i class="fa-solid fa-user"></i> Your Zerodha Account <br/>
                </h4>
            ...
            <div className="col-4 p-5 mt-2 mb-2">
                <h4 className='fs-4' style={{color: "#000"}}>
                    <i class="fa-solid fa-chart-column"></i> Your Zerodha Account <br/>
                </h4>
            ...
            <div className="col-4 p-5 mt-2 mb-2">
                <h4 className='fs-4' style={{color: "#000"}}>
                    <i class="fa-solid fa-coins"></i> Coin <br/>
                </h4>
                ...
                <a href="" style={{textDecoration: 'none', lineHeight: '2.5'}}>Buy and selling through Coin</a> <br/>
                ...
                <a href="" style={{textDecoration: 'none', lineHeight: '2.5'}}>Government of Securities</a> <br/>
            </div>
            </div>
