    ...
    return (
        <div className='container'>
            <div className="row p-5 mt-5">
                <h1 className='fs-3 text-center' style={{color: "#000"}}>
                    We pioneered the discount broking model in India. <br/>
                    Now, we are breaking ground with our technology.
                </h1>
            </div>
            <div className="row p-5 mt-5 border-top text-muted" style={{ fontSize: '0.95em', lineHeight: '1.8' }}>
                ...
                <div className="col-6 p-5">
                    ...
                    <p><a href="https://www.rainmatter.com/" target="_blank" rel="noopener noreferrer" style={{textDecoration: 'none'}}>Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p> <br/>
